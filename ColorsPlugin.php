 ...
 *
 * Craft access to phpColors library and methods
 *
 * --snip--
...
class ColorsPlugin extends BasePlugin
{
    ...
    {
        return Craft::t('Craft access to phpColors library and methods');
    }
    ...
    {
        return 'https://github.com/@cole007/colors/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/@cole007/colors/master/releases.json';
    }
